	...
	for(var x=0; x < menu.length; x++){
		...
		salida += '<div class="row" style="background: url(img/'+hoja.img+'.jpg); background-repeat:no-repeat; background-size:100% 100%; background-attachment: fixed; min-height="100%">'
			...
			for(var y=0; y < productos.length; y++){
				...
				if(hoja.orientacion == 'L'){
					salida += '<div class="col-sm-1 col-md-1 col-lg-1" style="padding-left:2em;">&nbsp;</div>'+
						  '<div class="col-sm-7 col-md-7 col-lg-7">'+
								'<font style="color: #D43854; font-family: '+"'"+'Algeria'+"'"+', sans-serif; font-size: 1.9rem;">'+nombre+'</font>'+
								'<font style="color: #FE1D17; font-family: Pussycat, Algerian, Broadway; font-size: 1.8rem;">&nbsp;'+puntos+'</font>'+								
								'<font style="color: #D43854; font-family: Pussycat, Algerian, Broadway; font-size: 1.9rem;">&nbsp;$'+producto.precio+'</font>'+
						  '</div>' +
						  '<div class="col-sm-4 col-md-4 col-lg-4">&nbsp;</div>'+
						  // Segundo renglon
						  '<div class="col-sm-1 col-md-1 col-lg-1" style="padding-left:2em;">&nbsp;</div>'+
