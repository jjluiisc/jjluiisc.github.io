...
'				<div class="tab-content">';
					for(a=0;a<personajes.length;a++){
						...
						salida +='<div id="personaje_'+padre+identificador+personajes[a].id+'" class="tab-pane fade'+(a==0?' in active':'')+'">'+
								 '	</br>';		
								 salida +='<div class="row"><div class="ccol-lg-4 col-md-4 col-sm-12"><img src="/ama/img/menu/'+nombre+'.jpg" alt="'+nombre+'"></div><div class="ccol-lg-4 col-md-4 col-sm-12">$ precio</div><div class="ccol-lg-4 col-md-4 col-sm-12"></div></div>';
